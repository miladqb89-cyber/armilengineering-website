...
const sections = [
  {
    id: "home",
    label: "Home",
    image: "/images/theme-steel-connection.jpg",
    eyebrow: "Engineering Precision. Delivered with Confidence.",
    title: "Advanced steel detailing, modeling, and engineering solutions.",
    intro:
      "ArMil Engineering & Detailing is a specialized provider of structural steel detailing and engineering support services. We combine advanced technology, industry expertise, and a deep understanding of construction workflows to deliver accurate, buildable solutions.",
    body:
      "Our approach focuses on precision, coordination, and performance—ensuring every project is executed to the highest standards from concept through completion.",
  },
  {
    id: "about",
    label: "About",
    image: "/images/theme-abstract-structure.jpg",
    eyebrow: "About ArMil",
    title: "Built on precision, technical expertise, and commitment to quality.",
    intro:
  ...
  },
  {
    id: "services",
    label: "Services",
    image: "/images/theme-construction-skyline.jpg",
    eyebrow: "Services",
    title: "Technical expertise aligned with real project needs.",
    intro:
      "Our service offering is designed to support fabrication, coordination, and construction execution with confidence.",
    body:
      "Each service below is developed around constructability, clarity, workflow coordination, and project performance.",
  },
  {
    id: "projects",
    label: "Projects",
    image: "/images/theme-steel-bridge.jpg",
    eyebrow: "Projects",
    title: "Technical excellence, detail, and dependable delivery.",
    intro:
  ...
  },
  {
    id: "contact",
    label: "Contact",
    image: "/images/theme-washington-dc.jpg",
    eyebrow: "Contact",
    title: "Partner with a team that understands precision, performance, and project success.",
    intro:
      "Contact ArMil Engineering & Detailing to discuss how we can support your next project with confidence and expertise.",
    body:
      "Use the quote form below to send a real message through your website.",
  },
];
...
const serviceCards = [
  {
    ...
    text: "We deliver fully coordinated, fabrication-ready steel detailing packages including shop drawings, erection drawings, and material take-offs. Every detail is developed with a focus on constructability, clarity, and compliance with project specifications and industry standards.",
    icon: DraftingCompass,
  },
  {
    title: "3D Modeling (Tekla Structures)",
    text: "Our team utilizes Tekla Structures to develop highly detailed and accurate 3D models that reflect real-world conditions. This enables advanced visualization, clash detection, and seamless integration with project teams, reducing risk and improving overall efficiency.",
    icon: Boxes,
  },
  {
    title: "Engineering Coordination & Support",
    text: "We provide comprehensive engineering coordination services, supporting connection design workflows, reviewing structural requirements, and resolving technical challenges. Our goal is to bridge the gap between design intent and fabrication reality.",
    icon: FileText,
  },
  {
    title: "Project Coordination",
    text: "Effective coordination is critical to project success. We work closely with contractors, fabricators, and engineers to streamline communication, minimize conflicts, and ensure alignment across all stages of the project lifecycle.",
    icon: Building2,
  },
  {
    title: "Construction & Field Support",
    text: "During construction, we provide responsive support including revisions, field adjustments, and updated documentation. Our team ensures that changes are implemented efficiently while maintaining design integrity and accuracy.",
    icon: Globe,
  },
];
      ...
      <header className="site-header">
        <div className="container header-inner">
          ...
          <div className="header-actions">
            <button onClick={() => scrollToSection("contact")} className="btn btn-primary desktop-only">
              Request a Quote
            </button>
            <button onClick={() => setMobileOpen((v) => !v)} className="mobile-btn">
      ...
      <div className="topbar">
        <div className="container topbar-inner">
          <div className="topbar-group">
            <span><Phone size={14} /> 571-317-5986</span>
            <span><Mail size={14} /> armilengineering@yahoo.com</span>
          </div>
          <div className="topbar-group">
            <span><MapPin size={14} /> Virginia • Maryland • Washington, DC</span>
          </div>
        </div>
      </div>
        ...
        {sections.map((section) => (
          ...
          >
            <div className="container story-grid">
              ...
              >
                <div className="pill">
                  <Sparkles size={14} /> {section.eyebrow}
                </div>
                <h1>{section.title}</h1>
              ...
              <div className="story-cards">
                  ...
                  <>
                    <ScrollCard>
                      ...
                      <p>
                        ...
                        alongside contractors, fabricators, and engineering teams that value precision,
                        buildability, and clear communication.
                      </p>
                    </ScrollCard>
                    ...
                    <ScrollCard>
                      <h3>How We Work</h3>
                      <p>
                        Our workflow is built around Tekla Structures modeling, coordinated detailing,
                        responsive revisions, and fabrication-minded deliverables that support
                ...
                {section.id === "contact" && (
                  <>
                    ...
                    <ScrollCard className="final-cta">
                      <div className="mini-pill">Let’s Build With Confidence</div>
                      <h3>Let’s support your next project with precision and confidence.</h3>
                      <p>
                        From detailing and Tekla modeling to coordination and field support, ArMil
                        is ready to help move your project forward.
                      </p>
                      <div className="hero-actions">
                        <button
                          onClick={() => (window.location.href = "mailto:armilengineering@yahoo.com")}
                          className="btn btn-primary"
                        >
                          Email ArMil
                        </button>
                        <button
                          onClick={() => (window.location.href = "tel:5713175986")}
